...
//if("992px" <= width)
//{
    //document.getElementById("about").style.margin="0px 10px 0px 10px";
    //document.getElementById("mission").style.margin="0px 10px 0px 10px";
    //document.getElementById("diet").style.margin="0px 10px 0px 10px";
    //document.getElementById("recipes").style.margin="0px 10px 0px 10px";
    //document.getElementById("fitness").style.margin="0px 10px 0px 10px";
    //document.getElementById("habits").style.margin="0px 10px 0px 10px";
